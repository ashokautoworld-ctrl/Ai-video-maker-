...
newSongBtn.addEventListener(
  ...
  () => {
    ...
    songStyle.value = "Bollywood";

    voiceFeel.value = "Natural";
...
function openProject(id) {
  ...
  songStyle.value =
    project.songStyle || "Bollywood";

  voiceFeel.value =
    project.voiceFeel || "Natural";

  structure.value =
    project.structure || "Full Song";
